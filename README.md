...
**a. Data should be as valid and complete as possible**. You can run queries to figure out if you have NULL values, if you have re
...
## Challenges 
With this being such a big project early in 
